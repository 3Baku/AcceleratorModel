...
### Opis folderów
W folderze 'grafika' znajdują się pliki do programu KiCad 9.0 dzięki którym można wczytać schemat i edytować go dowolnie. Na podstawie tego pliku wygenerowany jest ./Schematy/ObwodSchemat.png.
Mieści się w nim README_schemat z ważnym komentarzem,
...
W folderze 'Schematy' mieści się flowchart kodu, ideowy schemat układu pomiarowego, oraz schemat obwodu używanego do pomiaru prędkości.
